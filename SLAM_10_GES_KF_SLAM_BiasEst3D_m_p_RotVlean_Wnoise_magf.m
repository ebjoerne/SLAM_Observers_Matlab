...
for i=0:h:time_end
    ...
    if (i==3000)
        ...
        MAGdrop=0;
            ...
            %vectors
     v_n_1=compas_n*MAGdrop;
%      v_n_2=v/norm(v);
     v_n_2=gravity_m;
     v_n_3=S(gravity_m)*compas_n*MAGdrop;
%      v_n_3=S(v_n_2)*compas_n;
     
          v_b_1=R_nb'*compas_n*MAGdrop+sigma_mag*randn(3,1)*MAGdrop;
%      v_b_2=nu/norm(nu);
     v_b_2=R_nb'*(gravity_m+f/9.81)+sigma_acc*randn(3,1);
     v_b_3=S(R_nb'*(gravity_m+f/9.81))*R_nb'*compas_n*MAGdrop;
%      v_b_3=S(R_nb'*v_n_2)*R_nb'*compas_n;
       
%              %vectors
%      v_n_1=compas_n*MAGdrop;
% %      v_n_2=v/norm(v)*MAGdrop;
%      v_n_2=gravity_m;
%      v_n_3=S(gravity_m)*compas_n*MAGdrop;
% %      v_n_3=S(v_n_2)*compas_n*MAGdrop;
%      
%           v_b_1=R_nb'*compas_n*MAGdrop;
% %      v_b_2=nu/norm(nu)*MAGdrop;
%      v_b_2=R_nb'*gravity_m;
%      v_b_3=S(R_nb'*gravity_m)*R_nb'*compas_n*MAGdrop;
% %      v_b_3=S(R_nb'*v_n_2)*R_nb'*compas_n*MAGdrop;
    end
...
figure 
subplot(3,1,1)
plot(time(1,2000*0.1/h:end),OMEGA_M(1,2000*0.1/h:end)'-B_GRIP_HAT(1,2000*0.1/h:end)','g')
hold on
plot(time(1,2000*0.1/h:end),OMEGA_M(1,2000*0.1/h:end)'-B_HAT(1,2000*0.1/h:end)','b')
plot(time(1,2000*0.1/h:end),OMEGA_BIB(1,2000*0.1/h:end)','r-.')
...
subplot(3,1,2)
plot(time(1,2000*0.1/h:end),OMEGA_M(2,2000*0.1/h:end)'-B_GRIP_HAT(2,2000*0.1/h:end)','g')
hold on
plot(time(1,2000*0.1/h:end),OMEGA_M(2,2000*0.1/h:end)'-B_HAT(2,2000*0.1/h:end)','b')
plot(time(1,2000*0.1/h:end),OMEGA_BIB(2,2000*0.1/h:end)','r-.')
legend(leg)
xlabel('[s]')
ylabel('1/s^2)')
...
subplot(3,1,3)
plot(time(1,2000*0.1/h:end),OMEGA_M(3,2000*0.1/h:end)'-B_GRIP_HAT(3,2000*0.1/h:end)','g')
hold on
plot(time(1,2000*0.1/h:end),OMEGA_M(3,2000*0.1/h:end)'-B_HAT(3,2000*0.1/h:end)','b')
plot(time(1,2000*0.1/h:end),OMEGA_BIB(3,2000*0.1/h:end)','r-.')
legend(leg)
xlabel('[s]')
ylabel('1/s^2)')
...
figure 
subplot(3,1,1)
plot(time(1,1:2000),OMEGA_M(1,1:2000)'-B_GRIP_HAT(1,1:2000)','g')
hold on
plot(time(1,1:2000),OMEGA_M(1,1:2000)'-B_HAT(1,1:2000)','b')
plot(time(1,1:2000),OMEGA_BIB(1,1:2000)','r-.')
...
subplot(3,1,2)
plot(time(1,1:2000),OMEGA_M(2,1:2000)'-B_GRIP_HAT(2,1:2000)','g')
hold on
plot(time(1,1:2000),OMEGA_M(2,1:2000)'-B_HAT(2,1:2000)','b')
plot(time(1,1:2000),OMEGA_BIB(2,1:2000)','r-.')
legend(leg)
xlabel('[s]')
ylabel('1/s^2)')
...
subplot(3,1,3)
plot(time(1,1:2000),OMEGA_M(3,1:2000)'-B_GRIP_HAT(3,1:2000)','g')
hold on
plot(time(1,1:2000),OMEGA_M(3,1:2000)'-B_HAT(3,1:2000)','b')
plot(time(1,1:2000),OMEGA_BIB(3,1:2000)','r-.')
legend(leg)
xlabel('[s]')
ylabel('1/s^2)')
%   EULER_M=zeros(3,length(time));
...
figure
subplot(3,1,1)
plot(time(1,1:end),EULER_GRIP_HAT(1,1:end)'*180/pi,'g')
xlabel('[s]')
ylabel('[deg]')

hold on
plot(time(1,1:end),EULER_HAT(1,1:end)'*180/pi,'b')

plot(time(1,1:end),EULER_M(1,1:end)'*180/pi,'r-.')
title('Euler angles')
legend(leg)

subplot(3,1,2)
plot(time(1,1:end),EULER_GRIP_HAT(2,1:end)'*180/pi,'g')

hold on
plot(time(1,1:end),EULER_HAT(2,1:end)'*180/pi,'b')
plot(time(1,1:end),EULER_M(2,1:end)'*180/pi,'r-.')
legend(leg)
xlabel('[s]')
ylabel('[deg]')
...
subplot(3,1,3)
plot(time(1,1:end),EULER_GRIP_HAT(3,1:end)'*180/pi,'g')
hold on
plot(time(1,1:end),EULER_HAT(3,1:end)'*180/pi,'b')
plot(time(1,1:end),EULER_M(3,1:end)'*180/pi,'r-.')
xlabel('[s]')
ylabel('[deg]')
...
figure
subplot(2,1,1)
title('bias estimates Yaw')
plot(time(1,1000*0.1/h:10:end),B_HAT(3,1000*0.1/h:10:end)','b')
legend('SLAM')
subplot(2,1,2)
plot(time(1,1000*0.1/h:10:end),B_GRIP_HAT(3,1000*0.1/h:10:end)','g')
xlabel('[s]')
legend('Comp')
xlabel('[s]')
% ylabel('1/s^2)')
